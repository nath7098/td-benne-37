...
export const cities: Record<string, City> = {
  ...
  'saumur': {
    ...
    neighborhoods: ['Centre-ville', 'Nantilly', 'Chemin-Vert', 'Saint-Lambert'],
    nearbyAreas: ['Saint-Hilaire-Saint-Florent', 'Bagneux', 'Distré', 'Dampierre-sur-Loire'],
    nearbyCities: ['chinon', 'bourgueil', 'langeais'],
    description: 'Location de bennes à Saumur. Service professionnel dans la Perle de l\'Anjou.',
    metaDescription: 'Location de bennes à Saumur (49400). Livraison rapide dans tout le Saumurois. Bennes gravats, déchets verts, encombrants. Devis gratuit. ☎ 06 01 37 04 43',
    uniqueContent: `Saumur, ville de 26 500 habitants surnommée la "Perle de l'Anjou", fait partie de notre zone d'intervention étendue. Cette cité historique en bord de Loire, célèbre pour son château, son École de Cavalerie et ses vignobles, connaît une activité importante de rénovation patrimoniale et de construction. TD Location de Bennes 37 étend son service jusqu'à Saumur pour répondre aux besoins des particuliers et professionnels du bâtiment. Nous intervenons dans tous les quartiers de Saumur, du centre historique avec ses maisons de tuffeau aux quartiers résidentiels de Nantilly et du Chemin-Vert. Notre expérience dans les villes historiques nous permet de nous adapter aux contraintes d'accès du Vieux Saumur, avec ses ruelles étroites et ses réglementations de préservation du patrimoine. Nous proposons une gamme complète de bennes (de 3m³ à 30m³) et garantissons un service professionnel pour tous vos travaux de rénovation, démolition ou construction à Saumur et dans le Saumurois.`
  },
  'chatellerault': {
    slug: 'chatellerault',
    name: 'Châtellerault',
    ...
    neighborhoods: ['Centre-ville', 'Châteauneuf', 'Targé', 'Antoigné', 'La Manufacture'],
    nearbyAreas: ['Naintré', 'Thuré', 'Usseau', 'Senillé-Saint-Sauveur'],
    nearbyCities: ['tours', 'descartes', 'loches'],
    description: 'Location de bennes à Châtellerault. Service professionnel dans la Vienne limitrophe.',
    metaDescription: 'Location de bennes à Châtellerault (86100). Livraison rapide depuis l\'Indre-et-Loire. Bennes gravats, déchets. Devis gratuit sous 24h. ☎ 06 01 37 04 43',
    uniqueContent: `Châtellerault, ville de 31 500 habitants située dans la Vienne mais proche de l'Indre-et-Loire, bénéficie de notre service de location de bennes professionnel. Cette cité industrielle et universitaire en bord de Vienne connaît une dynamique importante de rénovation urbaine et de développement immobilier. TD Location de Bennes 37 étend son service à Châtellerault pour répondre aux besoins croissants de cette zone frontalière. Nous intervenons dans tous les secteurs de Châtellerault, du centre historique avec son pont Henri IV aux quartiers de Châteauneuf, Targé et de la Manufacture. Notre positionnement nous permet de desservir efficacement cette ville et de proposer des solutions adaptées à tous types de chantiers. Que ce soit pour la rénovation d'immeubles anciens du centre-ville, des travaux de démolition industrielle ou la construction de logements neufs, nous mettons à disposition la benne adaptée et garantissons un service réactif à Châtellerault.`
  },
  'blois': {
    slug: 'blois',
    name: 'Blois',
    ...
    neighborhoods: ['Centre-ville', 'Vienne', 'Kennedy', 'Quinière', 'Cabochon'],
    nearbyAreas: ['Villebarou', 'La Chaussée-Saint-Victor', 'Saint-Gervais-la-Forêt', 'Vineuil'],
    nearbyCities: ['tours', 'montlouis-sur-loire', 'chateaurenault'],
    description: 'Location de bennes à Blois. Service professionnel dans le Loir-et-Cher limitrophe.',
    metaDescription: 'Location de bennes à Blois (41000). Livraison rapide depuis Tours. Bennes gravats, déchets verts, encombrants. Devis gratuit. ☎ 06 01 37 04 43',
    uniqueContent: `Blois, préfecture du Loir-et-Cher avec 45 900 habitants, fait partie de notre zone d'intervention étendue en vallée de la Loire. Cette ville royale, célèbre pour son château Renaissance et son patrimoine historique exceptionnel, connaît une activité soutenue de rénovation patrimoniale et de développement urbain. TD Location de Bennes 37 étend son service à Blois pour accompagner les particuliers et professionnels dans leurs projets. Nous intervenons dans tous les quartiers de Blois, du centre historique classé avec ses escaliers Denis Papin aux quartiers résidentiels de Vienne, Kennedy et de la Quinière. Notre expérience dans les villes du Val de Loire nous permet de comprendre les spécificités d'accès et les contraintes patrimoniales propres à Blois. Nous proposons une gamme complète de bennes adaptées à tous types de travaux, de la mini-benne pour les ruelles escarpées du Vieux Blois aux grandes bennes pour les chantiers d'envergure. Notre engagement de service professionnel s'applique également à Blois avec une livraison rapide et un accompagnement personnalisé.`
  },
  'descartes': {
    slug: 'descartes',
    name: 'Descartes',
    ...
    neighborhoods: ['Centre-ville', 'Balesmes', 'Le Mail', 'Courtille'],
    nearbyAreas: ['Abilly', 'Bossay-sur-Claise', 'La Celle-Guenand', 'Ferrière-Larçon'],
    nearbyCities: ['loches', 'chatellerault'],
    description: 'Location de bennes à Descartes. Service professionnel dans le sud Touraine.',
    metaDescription: 'Location de bennes à Descartes (37160). Livraison rapide dans le sud de l\'Indre-et-Loire. Bennes gravats, déchets. Devis gratuit. ☎ 06 01 37 04 43',
    uniqueContent: `Descartes, petite ville de 3 800 habitants située dans le sud de l'Indre-et-Loire, anciennement appelée La Haye-Descartes, bénéficie de notre service de location de bennes professionnel. Cette cité de caractère en bord de Creuse, patrie du philosophe René Descartes, connaît une activité régulière de rénovation de son patrimoine bâti ancien. TD Location de Bennes 37 dessert Descartes et sa région avec le même engagement de qualité que dans l'ensemble du département. Nous intervenons dans tous les secteurs de Descartes, du centre historique avec ses maisons anciennes aux quartiers plus récents de Balesmes et de la Courtille. Notre connaissance du sud Touraine et de ses spécificités rurales nous permet de proposer des solutions adaptées à chaque situation. Que vous réalisiez la rénovation d'une maison de bourg, des travaux agricoles ou un projet de construction neuve, nous mettons à disposition la benne appropriée et garantissons un service réactif même dans cette zone plus éloignée de l'agglomération tourangelle.`
  },
  'loches': {
    slug: 'loches',
    name: 'Loches',
    ...
    neighborhoods: ['Cité royale', 'Centre-ville', 'Beaulieu', 'Moulins', 'Vignemont'],
    nearbyAreas: ['Perrusson', 'Saint-Hippolyte', 'Chambourg-sur-Indre', 'Azay-sur-Indre'],
    nearbyCities: ['tours', 'montlouis-sur-loire', 'descartes'],
    description: 'Location de bennes à Loches. Service professionnel dans la cité royale médiévale.',
    metaDescription: 'Location de bennes à Loches (37600). Livraison rapide dans le sud Touraine. Bennes gravats, déchets verts, encombrants. Devis gratuit. ☎ 06 01 37 04 43',
    uniqueContent: `Loches, ville de 6 500 habitants située dans le sud de l'Indre-et-Loire, est une cité royale médiévale d'exception classée Ville d'Art et d'Histoire. Son donjon du XIe siècle et son château royal font de Loches un joyau patrimonial de la Touraine. TD Location de Bennes 37 dessert Loches et sa région avec une attention particulière portée à la préservation de ce patrimoine exceptionnel. Nous intervenons dans tous les quartiers de Loches, de la Cité royale fortifiée avec ses ruelles médiévales au centre-ville et aux secteurs résidentiels de Beaulieu et Vignemont. Notre expérience dans les villes historiques nous permet de comprendre les contraintes spécifiques d'accès et les réglementations patrimoniales strictes qui s'appliquent à Loches. Nous proposons des solutions adaptées avec notre gamme complète de bennes, incluant des modèles compacts pour les accès difficiles de la vieille ville. Que ce soit pour la rénovation d'une maison de caractère dans l'enceinte médiévale ou pour un chantier en périphérie, nous garantissons un service professionnel et réactif à Loches.`
  },
  'loudun': {
    slug: 'loudun',
    name: 'Loudun',
    ...
    neighborhoods: ['Centre-ville', 'Martray', 'Faubourg Saint-Lazare', 'Les Roches'],
    nearbyAreas: ['Aulnay', 'Berrie', 'Ranton', 'Sammarçolles'],
    nearbyCities: ['chinon', 'bourgueil', 'chatellerault'],
    description: 'Location de bennes à Loudun. Service professionnel dans la Vienne limitrophe du 37.',
    metaDescription: 'Location de bennes à Loudun (86200). Livraison rapide depuis l\'Indre-et-Loire. Bennes gravats, déchets. Devis gratuit sous 24h. ☎ 06 01 37 04 43',
    uniqueContent: `Loudun, ville de 6 700 habitants située dans le nord de la Vienne mais très proche de l'Indre-et-Loire, bénéficie de notre service de location de bennes professionnel. Cette petite cité de caractère, célèbre pour son histoire et son patrimoine Renaissance, connaît une activité régulière de rénovation et de préservation de son bâti ancien. TD Location de Bennes 37 étend son service à Loudun pour répondre aux besoins de cette zone frontalière entre Touraine et Poitou. Nous intervenons dans tous les secteurs de Loudun, du centre historique avec ses hôtels particuliers et sa Tour Carrée aux faubourgs et quartiers résidentiels. Notre positionnement géographique et notre connaissance de cette zone nous permettent de garantir un service réactif à Loudun. Que ce soit pour la rénovation d'une maison de ville ancienne, des travaux de démolition ou un projet de construction, nous proposons la benne adaptée à vos besoins et aux contraintes d'accès de votre chantier. Notre engagement de qualité et de proximité s'applique également à Loudun et à ses communes environnantes.`
  },
  'vendome': {
    slug: 'vendome',
    name: 'Vendôme',
    ...
    neighborhoods: ['Centre-ville', 'Rochambeau', 'Capucins', 'Vendôme-Est', 'Champ-Rouillé'],
    nearbyAreas: ['Villiers-sur-Loir', 'Saint-Ouen', 'Naveil', 'Areines'],
    nearbyCities: ['tours', 'blois', 'chateaurenault'],
    description: 'Location de bennes à Vendôme. Service professionnel dans le nord du Loir-et-Cher.',
    metaDescription: 'Location de bennes à Vendôme (41100). Livraison rapide depuis Tours. Bennes gravats, déchets verts, encombrants. Devis gratuit. ☎ 06 01 37 04 43',
    uniqueContent: `Vendôme, sous-préfecture du Loir-et-Cher avec 15 800 habitants, fait partie de notre zone d'intervention étendue dans le Val de Loire. Cette ville d'art et d'histoire traversée par le Loir, célèbre pour son abbaye de la Trinité et ses jardins en terrasses, connaît une activité importante de rénovation patrimoniale et de développement urbain. TD Location de Bennes 37 étend son service à Vendôme pour accompagner les particuliers et professionnels du bâtiment dans leurs projets. Nous intervenons dans tous les quartiers de Vendôme, du centre historique avec ses bras du Loir et ses édifices classés aux quartiers résidentiels de Rochambeau, des Capucins et de Champ-Rouillé. Notre expérience dans les villes patrimoniales de la région Centre-Val de Loire nous permet de comprendre les spécificités de Vendôme, notamment les contraintes d'accès liées à la topographie et aux nombreux ponts de la ville. Nous proposons une gamme complète de bennes adaptées à tous types de travaux et garantissons un service professionnel avec livraison rapide à Vendôme et dans le Vendômois.`
  }
}
